...
The **New Zealand All Blacks** — 77% win rate over 100+ years, the most successful sports team in history — formalised this as the **"No Dickheads" rule**. [James Kerr's book *Legacy*](https://www.goodreads.com/book/show/18567621-legacy) documents it: if a player undermines trust, ability stops mattering. They're out. After every match, the most senior All Blacks sweep the locker room. No one is above the team.
...
**The more the output depends on coordination, handoffs, and shared context → the more the reward should be team-based.**

**The more the output depends on individual skill, judgment, and solo execution → the more the reward should be individual.**

**Always: make the contribution visible regardless of who gets the reward.**

## Back to the Champion Points Debate

So — should the champion points go to one person or the whole team?

The answer depends on what was shipped:

- If it was a **solo technical breakthrough** — a debugging insight, a performance optimisation, a piece of tooling that one person built — reward the individual. Make it visible. Celebrate it.
- If it was a **team delivery** — a feature that required design, engineering, QA, coordination, and cross-team dependencies — reward the team. The "driver" had a team that made driving possible.
- If it was **both** — and it usually is — do both. Recognise the individual's *specific contribution* publicly ("Priya's caching strategy saved us 40ms on every request") AND reward the team for shipping ("The checkout squad hit their Q1 target").

The mistake is treating it as binary. It's not "team OR individual." It's "what does the work structure tell us about where the value was created?"

## The Design Principles

If you're building a reward system — or arguing about one in a leadership meeting — here are the principles that the evidence supports:
